    ...
    <div className={styles.hero}>
      <div className={styles.heroInner}>
        ...
        <div className={styles.heroActions}>
          ...
          <Link className={styles.btnSecondary} href="https://github.com/collei-monitor/collei">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" style={{marginRight: '0.4rem', verticalAlign: 'middle'}}>
